...
\author{Arya G.~M.\\\texttt{arya@e3group.ai}}
\date{June 2026 \quad\textit{(workshop preprint; artifact: \texttt{pip install excise})}}
...
\texttt{github.com/e3group/excise}. \todo{finalize repo URL before
submission}
...
\texttt{paper/make\_figures.py}. \todo{verify all bib entries against
